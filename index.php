...
<body>
	<div class="flowtime">
		<div class="ft-section section-1" data-id="section-1">
			<div id="/section-1/page-1" class="ft-page page-1" data-id="page-1">
				<p class="text1"><span id="text-75" contenteditable="false">木子李</span> ❤ <span id="text-76" contenteditable="false">林夕梦</span></p>
				<p class="text2">按键盘 "↓" <span id="text-78" contenteditable="false">Please listen to my confession</span></p>
			</div>
			<div id="/section-1/page-2" class="ft-page page-2" data-id="page-2">
				<p class="top-text" id="text-1" contenteditable="false">过去的木子一直是一个人生活，享受着孤独，也憧憬着爱情。</p>
				<img src='img/iali63.jpg'  alt="过去的木子一直是一个人生活，享受着孤独，也憧憬着爱情。" />
			</div>
			<div id="/section-1/page-3" class="ft-page page-3 left-img" data-id="page-3">
				<h2 class="text" id="text-2" contenteditable="false">一个人的长廊</h2>
				<img src='img/iali35.jpg'  alt="一个人的长廊"/>
			</div>
			<div id="/section-1/page-4" class="ft-page page-4 full-img" data-id="page-4">
				<h2 class="center-text" id="text-3" contenteditable="false">一个人的山岗</h2>
		...
		<div class="ft-section section-3" data-id="section-3">
			<div id="/section-3/page-1" class="ft-page page-11 full-img" data-id="page-1">
				<h3 id="text-10" contenteditable="false">生活也不会总是一帆风顺</h3>
				<img src='img/iali24.jpg'  />
			</div>
			<div id="/section-3/page-2" class="ft-page page-12" data-id="page-2">
				<h3><span id="text-11" contenteditable="false">但他每次都能勇敢的面对</span><br /><span id="text-12" contenteditable="false">随时准备接受生活的挑战</span></h3>
				<img src='img/iali25.jpg' />
			</div>
			<div id="/section-3/page-3" class="ft-page page-13" data-id="page-3">
				<img src='img/iali64.jpg' alt='可是木子的爱情又在哪里呢？' />
				<h3 id="text-13" contenteditable="false">可是木子的爱情又在哪里呢？</h3>
			</div>
			<div id="/section-3/page-4" class="ft-page page-14 left-img" data-id="page-4">
				<h3 id="text-14" contenteditable="false">在镜子里面吗？他不敢相信</h3>
				<img src='img/iali46.jpg' />
			</div>
			<div id="/section-3/page-5" class="ft-page page-15 left-img" data-id="page-5">
				<h3><span id="text-15" contenteditable="false">他去问大树，我的爱情在哪里？</span><br /><span id="text-16" contenteditable="false">大树告诉他，也许就在不远的地方</span></h3>
				<img src='img/iali45.jpg' />
			</div>
			<div id="/section-3/page-6" class="ft-page page-16 left-img" data-id="page-6">
				<h3><span id="text-17" contenteditable="false">于是，木子一个人继续向前走</span><br /><span id="text-18" contenteditable="false">走在茫茫的雪地上</span></h3>
				<img src='img/iali66.jpg' />
			</div>
			<div id="/section-3/page-7" class="ft-page page-17 top-text" data-id="page-7">
				<h3 id="text-19" contenteditable="false">直到有一天木子与林夕相遇了</h3>
		...
		<div class="ft-section section-7" data-id="section-7">
			...
			<div id="/section-7/page-3" class="ft-page page-41" data-id="page-3">
				...
				<h3 id="text-46" contenteditable="false"> 我又怎会有勇气飞的更高更远</h3>
			</div>
			<div id="/section-7/page-4" class="ft-page page-42" data-id="page-4">
				<h3><span id="text-47" contenteditable="false">我们为了更好地未来而改变自己</span><br /><span id="text-48" contenteditable="false">人们都说狮子座会保护身边的人</span></h3>
				<img src='img/iali69.jpg'  />
			</div>
			<div id="/section-7/page-5" class="ft-page page-43" data-id="page-5">
				<img src='img/iali42.jpg' />
				<h3 id="text-49" contenteditable="false">我曾经是巨蟹座，我愿为你变成狮子座</h3>
			</div>
			<div id="/section-7/page-6" class="ft-page page-44 left-img" data-id="page-6">
				<h3><span id="text-50" contenteditable="false">爱情就像花草一样</span><br /><span id="text-51" contenteditable="false">需要用包容来浇灌</span></h3>
				<img src='img/iali0.jpg' />
			</div>
			<div id="/section-7/page-7" class="ft-page page-45 left-img" data-id="page-7">
				<h3><span id="text-52" contenteditable="false">后来后来，也就是一个月以后~</span><br /><span id="text-53" contenteditable="false">木子要开始为林夕准备浪漫</span></h3>
		...
		<div class="ft-section section-8" data-id="section-8">
			<div id="/section-8/page-1" class="ft-page page-46" data-id="page-1">
				...
				<h3>
					<span id="text-54" contenteditable="false">谁说程序员不懂浪漫</span>
					<span id="text-55" contenteditable="false">我们是工程师~哼</span>
					<span id="text-56" contenteditable="false">木子想看到</span>
					<span id="text-57" contenteditable="false">林夕开心的样子</span>
				</h3>
			</div>
			<div id="/section-8/page-2" class="ft-page page-47 top-text" data-id="page-2">
				<img src='img/iali58.jpg' />
				<h3>
					<span id="text-58" contenteditable="false">想想后面还有一辈子</span>
					<span id="text-59" contenteditable="false">我就好开心</span>
					<span id="text-60" contenteditable="false">因为可以和你</span>
					<span id="text-61" contenteditable="false">去全世界好多地方玩</span></h3>
				
			</div>
			<div id="/section-8/page-3" class="ft-page page-48 left-img" data-id="page-3">
				<p><span id="text-62" contenteditable="false">我也会继续努力</span><br /><span id="text-63" contenteditable="false">为了木子和林夕的梦之城堡</span></p>
				<img src='img/iali65.jpg'  />
			</div>
			<div id="/section-8/page-4" class="ft-page page-49 full-img" data-id="page-4">
			<img src='img/iali71.jpg' />
				<p class="text">
					<span class='text' id="text-64" contenteditable="false">木子很幸福，因为他找到了林夕。他相信后面的每天都会是快乐的</span><br />
					<span class='text' id="text-65" contenteditable="false">简简单单，体会着与林夕在一起的每一个刻</span>
				</p>
			</div>
			<div id="/section-8/page-5" class="ft-page page-50" data-id="page-5">
				<p class='text' id="text-66" contenteditable="false">每天睡梦前的我爱你~每天清晨睁眼的第一声早安~这只是他们幸福生活中的一些小事，小到无法引起别人的注意。可这是属于木子和林夕的幸福生活。</p>
			...
			<div id="/section-8/page-6" class="ft-page page-51" data-id="page-6">
				<p>
					<span id="text-67" contenteditable="false">林夕：永远有多远？</span><br />
					<span id="text-68" contenteditable="false">木子：比时间多一秒就是永远，我会永远爱你</span><br />
					<span id="text-69" contenteditable="false">林夕：世界有多大？</span><br />
					<span id="text-70" contenteditable="false">木子：你走到哪里，世界就有多大</span>
					</p>
			</div>
		</div>
		<div class="ft-section section-9" data-id="section-9">
			<div id="/section-9/page-1" class="ft-page page-52 full-img" data-id="page-1">
				<h3 id="text-71" contenteditable="false">愿得一人心，白首不相离</h3>
			...
			<div id="/section-9/page-2" class="ft-page page-53" data-id="page-2">
				...
				<h3 id="text-72" contenteditable="false">陌上花开</h3>
			</div>
			...
			<div id="/section-9/page-4" class="ft-page page-55 right-img" data-id="page-4">
				...
				<p class="text">
					<span id="text-73" contenteditable="false">木子和林夕的故事会一直继续下去。</span><br />
					<span id="text-74" contenteditable="false">无论精彩、平淡都会是他们喜欢的。</span><br />
					<br />
					<br />
	...
	<div class="write-tip">
		<span class="showtip">小可爱：当你看到这句话的时候证明你已经看到了这个页面了</span>
		<span style="display:none">小可爱：是不是真的真的很感动？我觉得你可以亲我了~</span>
		<a href="./time.php"><button id="write-submit">小惊喜</button></a>
